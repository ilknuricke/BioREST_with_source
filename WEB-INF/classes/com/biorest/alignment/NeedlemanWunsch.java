...
public class NeedlemanWunsch {
	...
	public static void dumpMatrix(int[][] matrix, String row, String column){
	  ...
	  * Runtime complexity: O(NxM), Space complexity: O(NxM) where N,M are lengths of the sequences
	  */
	 public static AlignmentResult computeNWAlignment(String seq1, String seq2, SimpleAlignmentParameters parameters) {
			
		    //It is easier to index and faster to use integer matrix for fixed length storage
		    ...
		    result.setAlignments(new String[] {alignedSequence1.reverse().toString(), alignedSequence2.reverse().toString()});
